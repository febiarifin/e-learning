...
<body>
    ...
    <div class="container">
        ...
        <form action="?m=prosesLogin" method="post" enctype="multipart/form-data">
            <label class="font-weight-normal">NIS</label>
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="basic-addon1"><?php include ICON . 'user.php'; ?></span>
                </div>
                <input type="text" name="_nis" class="form-control" placeholder="Masukkan NIS" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required>
            </div>
