...
if (isset($_POST)) {
    ...
    $sql = "INSERT INTO siswa(nis,nama,jeniskelamin,tempat_lahir,tanggal_lahir,alamat,telepon,password,foto) VALUES(:nis,:nama,:jeniskelamin,:tempat_lahir,:tanggal_lahir,:alamat,:telepon,:password,:foto)";
    ...
    if ($simpan) {
        $_SESSION['sukses'] = "Siswa sukses ditambahkan.";
